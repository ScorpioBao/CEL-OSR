...
def main():
    ...
    train_arg_parser.add_argument("--epochs", type=int, default=150,
                                  help='Number of epochs to train.')
    train_arg_parser.add_argument("--batch_size", type=int, default=16,
                                  help="")
    ...
    train_arg_parser.add_argument("--weight_decay", type=float, default=0.0005,
                                  help='')
    train_arg_parser.add_argument("--logs", type=str, default='PACS/logs/',
                                  help='')
    train_arg_parser.add_argument("--model_path", type=str, default='PACS/models/',
                                  help='')
    ...
    train_arg_parser.add_argument("--loops_adv", type=int, default=15,
                                  help="")
    train_arg_parser.add_argument("--k", type=int, default=3,
                                  help="")
